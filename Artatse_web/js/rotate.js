...
img_box.addEventListener('mouseover', function() {
    clearInterval(timer)
    let showL = document.getElementById("left_btn");
    showL.style.width="55px";
    let showR = document.getElementById("right_btn");
    showR.style.width="55px";
})
...
img_box.addEventListener('mouseout', function() {
    timer = setInterval(swapFormat, 10000)
    let disL = document.getElementById("left_btn");
    disL.style.width="0px";
    let disR = document.getElementById("right_btn");
    disR.style.width="0px";
})
